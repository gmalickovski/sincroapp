...
const RegisterPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Salva o nome de exibição no perfil do Firebase Auth
            await updateProfile(userCredential.user, {
                displayName: `${firstName} ${lastName}`
            });

            // O onAuthStateChanged no App.jsx cuidará do resto
            navigate('/app'); 
                ...
                <form onSubmit={handleSubmit} className="bg-gray-800 p-8 rounded-lg shadow-xl space-y-4">
                    <div className="flex flex-col md:flex-row gap-4">
                        <div className="w-full">
                            <label className="block text-sm font-bold mb-2 text-gray-300" htmlFor="firstName">Primeiro Nome</label>
                    ...
                    <div className="flex items-start">
                        <input id="agree" type="checkbox" checked={agreed} onChange={(e) => setAgreed(e.target.checked)} className="h-4 w-4 mt-1 bg-gray-700 border-gray-600 rounded text-purple-500 focus:ring-purple-600" />
                    ...
                    <div className="pt-2">
                        <button type="submit" disabled={loading} className="w-full bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-4 rounded-md transition duration-300 disabled:bg-purple-800">
