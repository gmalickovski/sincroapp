...
// Ícones movidos para dentro do arquivo
...
function LoginPage({ onBackToHomeClick }) {
             ...
             <div className="w-full max-w-sm">
                ...
                <div className="bg-gray-800/50 p-8 rounded-2xl border border-gray-700 shadow-xl">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-6"><label className="block text-sm font-medium text-gray-300 mb-2">Senha</label><input type="password" value={password} onChange={e => setPassword(e.target.value)} className="w-full bg-gray-900 border border-gray-600 rounded-lg p-3 text-sm" required /></div>
