...
import React, { useState, useEffect, useMemo } from 'react'; // React já está importado
...
// ...
// Outros componentes do arquivo (FloatingActionButton, MobilePreviewPanel, DesktopDetailPanel)
// ...
// ...
...
const DayCellGrid = React.memo(({ day, isSelected, onClick }) => {
    ...
    console.log(`Renderizando DayCellGrid para: ${day.date.getDate()}`);
...
// O restante do seu arquivo Calendar.jsx permanece exatamente igual...
// ...
// ...
